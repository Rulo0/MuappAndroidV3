...
public class GetMatchingUsersFragment extends Fragment implements OnFragmentInteractionListener {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        Glide.with(this).load(user.getPhoto()).placeholder(R.drawable.ic_logo_muapp_no_caption).bitmapTransform(new CropCircleTransformation(getContext())).diskCacheStrategy(DiskCacheStrategy.ALL).into(img_loading_face);
    }
