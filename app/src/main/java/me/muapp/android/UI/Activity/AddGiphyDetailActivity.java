...
public class AddGiphyDetailActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ((currentGiphy = getIntent().getParcelableExtra(CURRENT_GIPHY)) != null) {
            Glide.with(this).load(currentGiphy.getImages().getOriginal().getUrl()).asGif().priority(Priority.IMMEDIATE).diskCacheStrategy(DiskCacheStrategy.SOURCE).placeholder(R.drawable.ic_placeholder).fitCenter().dontAnimate().into(img_giphy_detail);
        }
    }
