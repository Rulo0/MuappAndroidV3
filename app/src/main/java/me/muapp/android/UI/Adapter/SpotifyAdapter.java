...
import me.muapp.android.UI.Activity.SpotifyDetailActivity;
import me.muapp.android.UI.Activity.SpotifySearchActivity;

import static me.muapp.android.UI.Activity.SpotifyDetailActivity.CURRENT_SONG;
        ...
        public void bind(final Song song) {
            ...
            container_spotify.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent spotifyIntent = new Intent(mContext, SpotifyDetailActivity.class);
                    spotifyIntent.putExtra(CURRENT_SONG, new Gson().toJson(song));
                    Log.wtf("currentSong", song.toString());
                    ((SpotifySearchActivity) mContext).startActivityForResult(spotifyIntent, SPOTIFY_REQUEST_CODE);
                }
            });
        }
    }
