...
public class ProfilePicturesAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        Glide.with(context).load(userAlbum.get(position)).error(R.drawable.ic_placeholder_error).diskCacheStrategy(DiskCacheStrategy.ALL).priority(Priority.IMMEDIATE).centerCrop().placeholder(R.drawable.ic_placeholder).into(img_profile_picture_big);
        container.addView(v);
        return v;
    }
